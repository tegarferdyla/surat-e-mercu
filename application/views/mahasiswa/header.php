...
<head>
  ...
  else if($this->uri->segment(2)=="lihat"){echo "Status Surat - E-Surat Mercu Buana";} ?></title>
    ...
    <div class="row" style="margin-left: 1%;">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          <li class="status">
            <?php echo $this->session->userdata('nama_mahasiswa');?></li>
            <li><a class="status" href="<?php echo site_url('mahasiswa/lihat') ?>">Lihat Status</a>
            </li>
            <li class="keluar">
              <?php echo anchor( 'login?logout=signout', 'keluar');?>
            </li>
          </ul>
        </div>
        <!-- /.navbar-collapse -->
