...
<head>
  ...
  <meta name="theme-color" content="#ffffff">
	<title>Token Anda Sudah Habis</title>
...
<body class="token">
	...
	<i class="fas fa-lock gembok fa-10x"></i>
			</div>
		</div>		
  <h3 class="text-center">TOKEN ANDA SUDAH HABIS. SILAHKAN RESET PASSWORD ULANG</h3>
  <div class="row">
  	<div class="col-md-4 col-md-offset-4">
  		<a class="btn btn-primary btn-block" href="<?php echo site_url('') ?>">Kembali Ke Beranda <i class="fas fa-home"></i></a>
  	</div>
  </div>
	</div>
</body>
