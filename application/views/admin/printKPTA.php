...
<body class="printkpta">
	<div class="container-fluid printKPTA">
		...
		<div class="container idsurat">
			<div class="row">
				<div class="col-xs-12"><p class="nomor">Nomor	:142/304/FSD/VII/2017</p></div>
			</div>
			<div class="row">
		...
		<div class="container kepadayth">
			...
			<p id="kepadayth">PT.Grab Indonesia</p>
			<p id="kepadayth-1">Jl.Bendungan No.47</p>
			<p id="kepadayth-1">Jakarta Pusat</p>
			<p id="kepadayth">Up. Bapak Didi</p>
			<p id="kepadayth">General Manajer HR & GA</p>
		</div>
