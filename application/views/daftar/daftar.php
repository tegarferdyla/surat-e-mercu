...
<div class="container form-login">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="alert alert-danger alert-dismissible">
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
						<h4>
							<i class="icon fa fa-close"></i>Informasi</h4>
					...
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="col-sm-9 col-xs-8">
								<input type="text" class="form-control" id="nim" value="<?=set_value('nimmhs')?>" name="nimmhs" placeholder="NIM" maxlength="8"
								onkeypress="return no(event)">
							</div>
						</div>
					</div>
				</div>
	...
	<h5 class="text-center">Sudah punya akun? silahkan
		<b>
			<a class="link-daftar" href="<?php echo site_url('login') ?>">login</a>
		</b>
	</h5>
</div>
</div>
