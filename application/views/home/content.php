...
<div class="container-fluid" id="step">
	<div class="container">
		...
		<div class="row">
			<div clas="col-md-12">
				<a class="btn btn-more col-md-8 col-md-offset-2 btn-lg wow fadeIn" data-wow-delay="1.5s" href="<?php echo site_url('tentang')?>">ALUR PROSES PENGAJUAN <span class="hidden-xs">SURAT</span> <i class="fas fa-arrow-circle-right fa-lg"></i></a>
			</div>
		</div>
	</div>
</div>