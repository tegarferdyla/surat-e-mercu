	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-2">
				<img src="<?php echo base_url('assets/image/logoesurat4.png')?>" class="img-responsive wow fadeInRightBig" alt="">
			</div>
		</div>
	</div>
</div>
...
<div class="container-fluid" id="step">
	<div class="container">
		...
		<div class="row">
			<div clas="col-md-12">
				<a class="btn btn-more col-md-8 col-md-offset-2 btn-lg  wow fadeIn"  data-wow-delay="2s" href="">ALUR PROSES PENGAJUAN <span class="hidden-xs">SURAT</span> <i class="fas fa-arrow-circle-right fa-lg"></i></a>
			</div>
		</div>
	</div>
</div>